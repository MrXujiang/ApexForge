<div align="center">
  ...
  <p>
    <a href="./demo.png"><strong>产品截图</strong></a>
    ·
    <a href="./demo.mov"><strong>视频演示</strong></a>
    ·
...
> 当前仓库已内置真实截图与视频演示。第一次了解项目时，建议先看下方截图和演示视频，再进入 `tech/doc/index.html` 阅读完整产品与技术文档。

<div align="center">
  <a href="./demo.png">
    <img alt="ApexForge AI CAD Studio 产品截图" src="./demo.png" width="100%" />
  </a>
  <br />
  <sub>自然语言生成 3D 模型 · 在线 API Key · Three.js 实时预览 · 属性编辑 · 模型导入</sub>
</div>
...
<div align="center">
  <a href="./demo.mov">
    <strong>观看 demo.mov 视频演示</strong>
  </a>
  <br />
  <sub>如果 GitHub 页面未直接预览视频，可点击上方链接打开或下载演示文件。</sub>
</div>
